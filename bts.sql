...
INSERT INTO `jurusan` (`jurusan_id`, `jurusan_nama`, `keterangan`, `jurusan_logo`, `jurusan_deskripsi`) VALUES
(1, 'AK', 'Akuntansi dan Keuangan Lembaga', 'ak.png', 'desc ak'),
(2, 'RPL', 'Rekayasa Perangkat Lunak', 'rpl.png', 'desc rpl'),
(3, 'TKJ', 'Teknik Komputer Jaringan', 'tkj.png', 'desc tkj'),
(4, 'TEI', 'Teknik Elektronika Industri', 'tei.png', 'desc tei'),
(5, 'TBSM', 'Teknik dan Bisnis Sepeda Motor', 'tbsm.png', 'desc tbsm'),
(6, 'TET', 'Teknik Energi Terbarukan', 'tet.png', 'desc tet');
